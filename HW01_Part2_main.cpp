...
int main()
{
	...
	image = imread("C:/Users/TETE/Desktop/OpenCVFiles/mm2.jpg", IMREAD_COLOR);
	...
	*/
	...
	int brown = 0;
	int green = 0;
	vector<double> hue(contours.size());
	for (size_t i = 0; i < contours.size(); i++)
	{
